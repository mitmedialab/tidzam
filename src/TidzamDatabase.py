...
class Dataset:
    def __init__(self, name="/tmp/dataset",p=0.9, data_size=(150,186), max_file_size=1000, split=0.9):
        ...
        self.type_dictionnary = {"airplane" : "ambiant_sound" ,
                                 "birds" : "content" ,
                                 "cicadas" : "ambiant_sound" ,
                                 "crickets" : "ambiant_sound" ,
                                 "frog" : "content" ,
                                 "mic_crackle" : "ambiant_sound" ,
                                 "no_signal" : "ambiant_sound" ,
                                 "quiet" : "ambiant_sound" ,
                                 "rain" : "ambiant_sound" ,
                                 "spring_peepers" : "ambiant_sound" ,
                                 "wind" : "ambiant_sound" ,}
            ...
            for i , cl in enumerate(self.labels_dic):
                ...
                for id in idx:
                    ...
                    if data_augmentation and type_dictionnary[cl] == "content":
                        try:
                            ambient_file                = random.choice(files[random.choice(ambiant_cl)])
                            ambiant_sound , samplerate  = sf.read(ambient_file)
