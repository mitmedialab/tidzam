...
class DNN:
    def __init__(self,data_size, n_classes):
        ...
        # Conv 1 - 2
        self.conv1 = tflearn.conv_2d(net, 48, 5, activation='relu', regularizer='L2', name="conv1")
        ...
        self.conv2 = tflearn.conv_2d(self.pool1, 15, 5, activation='relu', regularizer='L2', name="conv2")
        ...
        # Conv 3 - 4
        # Fully Connected
        self.fc1 = tflearn.fully_connected(self.pool2, 30, activation='relu', name="fc1")
